...
def get_db_url() -> str:
    ...
    # 使用 print() 输出调试信息（确保能看到）
    print(f"[DEBUG] DATABASE_URL env: {'Set' if os.getenv('DATABASE_URL') else 'Not set'}")
    print(f"[DEBUG] PGDATABASE_URL env: {'Set' if os.getenv('PGDATABASE_URL') else 'Not set'}")
